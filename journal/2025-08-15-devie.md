...
→ Based on the technique mentioned in the article we need a long password and we already know that the key in lengthy.  
...
→ We can use the same method for the cron job by 
